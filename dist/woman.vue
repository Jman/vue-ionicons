...
<script>
  export default {
    name: "woman-icon",
    data () {
      let iconTitle = this.title ? this.title : "Woman Icon"
      return {
        iconTitle
      }
    },
