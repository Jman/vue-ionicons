<template>
  <div class="ion android-microphone-icon" name="android-microphone-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Microphone Icon"
      return {
        iconTitle
      }
    },
