<template>
  <div class="ion ios-circle-filled-icon" name="ios-circle-filled-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-circle-filled-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Circle Filled Icon"
      return {
        iconTitle
      }
    },
