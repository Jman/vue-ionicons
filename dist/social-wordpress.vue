...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Wordpress Icon"
      return {
        iconTitle
      }
    },
