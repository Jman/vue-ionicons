...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Time Outline Icon"
      return {
        iconTitle
      }
    },
