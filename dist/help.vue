...
<script>
  export default {
    name: "help-icon",
    data () {
      let iconTitle = this.title ? this.title : "Help Icon"
      return {
        iconTitle
      }
    },
