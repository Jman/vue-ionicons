...
<script>
  export default {
    name: "umbrella-icon",
    data () {
      let iconTitle = this.title ? this.title : "Umbrella Icon"
      return {
        iconTitle
      }
    },
