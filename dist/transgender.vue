...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Transgender Icon"
      return {
        iconTitle
      }
    },
