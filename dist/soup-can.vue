...
<script>
  export default {
    name: "soup-can-icon",
    data () {
      let iconTitle = this.title ? this.title : "Soup Can Icon"
      return {
        iconTitle
      }
    },
