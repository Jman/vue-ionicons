...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Alarm Clock Icon"
      return {
        iconTitle
      }
    },
