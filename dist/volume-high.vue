...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Volume High Icon"
      return {
        iconTitle
      }
    },
