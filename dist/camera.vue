...
<script>
  export default {
    name: "camera-icon",
    data () {
      let iconTitle = this.title ? this.title : "Camera Icon"
      return {
        iconTitle
      }
    },
