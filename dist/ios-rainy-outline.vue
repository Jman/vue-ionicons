...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Rainy Outline Icon"
      return {
        iconTitle
      }
    },
