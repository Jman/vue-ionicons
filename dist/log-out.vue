...
<script>
  export default {
    name: "log-out-icon",
    data () {
      let iconTitle = this.title ? this.title : "Log Out Icon"
      return {
        iconTitle
      }
    },
