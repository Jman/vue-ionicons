<template>
  <div class="ion ios-personadd-outline-icon" name="ios-personadd-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Personadd Outline Icon"
      return {
        iconTitle
      }
    },
