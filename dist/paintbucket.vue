...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Paintbucket Icon"
      return {
        iconTitle
      }
    },
