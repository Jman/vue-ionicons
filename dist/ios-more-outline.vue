<template>
  <div class="ion ios-more-outline-icon" name="ios-more-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-more-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios More Outline Icon"
      return {
        iconTitle
      }
    },
