...
<script>
  export default {
    name: "xbox-icon",
    data () {
      let iconTitle = this.title ? this.title : "Xbox Icon"
      return {
        iconTitle
      }
    },
