...
<script>
  export default {
    name: "thumbsup-icon",
    data () {
      let iconTitle = this.title ? this.title : "Thumbsup Icon"
      return {
        iconTitle
      }
    },
