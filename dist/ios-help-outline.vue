<template>
  <div class="ion ios-help-outline-icon" name="ios-help-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-help-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Help Outline Icon"
      return {
        iconTitle
      }
    },
