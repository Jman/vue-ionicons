<template>
  <div class="ion android-color-palette-icon" name="android-color-palette-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Color Palette Icon"
      return {
        iconTitle
      }
    },
