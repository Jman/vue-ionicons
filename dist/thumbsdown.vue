...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Thumbsdown Icon"
      return {
        iconTitle
      }
    },
