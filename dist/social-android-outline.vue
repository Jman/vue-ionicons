...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Android Outline Icon"
      return {
        iconTitle
      }
    },
