...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Folder Outline Icon"
      return {
        iconTitle
      }
    },
