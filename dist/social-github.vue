<template>
  <div class="ion social-github-icon" name="social-github-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "social-github-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Github Icon"
      return {
        iconTitle
      }
    },
