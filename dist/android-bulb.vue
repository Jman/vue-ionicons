...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Bulb Icon"
      return {
        iconTitle
      }
    },
