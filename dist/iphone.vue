...
<script>
  export default {
    name: "iphone-icon",
    data () {
      let iconTitle = this.title ? this.title : "Iphone Icon"
      return {
        iconTitle
      }
    },
