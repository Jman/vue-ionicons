...
<script>
  export default {
    name: "gear-b-icon",
    data () {
      let iconTitle = this.title ? this.title : "Gear B Icon"
      return {
        iconTitle
      }
    },
