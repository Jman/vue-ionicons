...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Cloudy Outline Icon"
      return {
        iconTitle
      }
    },
