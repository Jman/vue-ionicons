<template>
  <div class="ion ios-unlocked-outline-icon" name="ios-unlocked-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-unlocked-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Unlocked Outline Icon"
      return {
        iconTitle
      }
    },
