...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Bitcoin Icon"
      return {
        iconTitle
      }
    },
