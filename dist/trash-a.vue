...
<script>
  export default {
    name: "trash-a-icon",
    data () {
      let iconTitle = this.title ? this.title : "Trash A Icon"
      return {
        iconTitle
      }
    },
