...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Locked Icon"
      return {
        iconTitle
      }
    },
