...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Rss Outline Icon"
      return {
        iconTitle
      }
    },
