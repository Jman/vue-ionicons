...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "No Smoking Icon"
      return {
        iconTitle
      }
    },
