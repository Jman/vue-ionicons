<template>
  <div class="ion ios-unlocked-icon" name="ios-unlocked-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-unlocked-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Unlocked Icon"
      return {
        iconTitle
      }
    },
