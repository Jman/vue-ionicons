...
<script>
  export default {
    name: "ios-loop-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Loop Icon"
      return {
        iconTitle
      }
    },
