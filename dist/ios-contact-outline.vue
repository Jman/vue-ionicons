<template>
  <div class="ion ios-contact-outline-icon" name="ios-contact-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Contact Outline Icon"
      return {
        iconTitle
      }
    },
