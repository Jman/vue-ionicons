...
<script>
  export default {
    name: "fork-repo-icon",
    data () {
      let iconTitle = this.title ? this.title : "Fork Repo Icon"
      return {
        iconTitle
      }
    },
