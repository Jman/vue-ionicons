...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Ionic Outline Icon"
      return {
        iconTitle
      }
    },
