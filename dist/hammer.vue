...
<script>
  export default {
    name: "hammer-icon",
    data () {
      let iconTitle = this.title ? this.title : "Hammer Icon"
      return {
        iconTitle
      }
    },
