...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Shuffle Strong Icon"
      return {
        iconTitle
      }
    },
