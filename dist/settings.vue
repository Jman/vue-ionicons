...
<script>
  export default {
    name: "settings-icon",
    data () {
      let iconTitle = this.title ? this.title : "Settings Icon"
      return {
        iconTitle
      }
    },
