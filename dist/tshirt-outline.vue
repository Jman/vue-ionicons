...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Tshirt Outline Icon"
      return {
        iconTitle
      }
    },
