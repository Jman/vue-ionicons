...
<script>
  export default {
    name: "trash-b-icon",
    data () {
      let iconTitle = this.title ? this.title : "Trash B Icon"
      return {
        iconTitle
      }
    },
