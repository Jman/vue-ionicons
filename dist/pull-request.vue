...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Pull Request Icon"
      return {
        iconTitle
      }
    },
