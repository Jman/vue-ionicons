...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Laptop Icon"
      return {
        iconTitle
      }
    },
