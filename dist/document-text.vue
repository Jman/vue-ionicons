...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Document Text Icon"
      return {
        iconTitle
      }
    },
