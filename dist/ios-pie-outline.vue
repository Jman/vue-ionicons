...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Pie Outline Icon"
      return {
        iconTitle
      }
    },
