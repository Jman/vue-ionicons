...
<script>
  export default {
    name: "icecream-icon",
    data () {
      let iconTitle = this.title ? this.title : "Icecream Icon"
      return {
        iconTitle
      }
    },
