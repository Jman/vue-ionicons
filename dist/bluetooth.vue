...
<script>
  export default {
    name: "bluetooth-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bluetooth Icon"
      return {
        iconTitle
      }
    },
