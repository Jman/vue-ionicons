...
<script>
  export default {
    name: "pricetags-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pricetags Icon"
      return {
        iconTitle
      }
    },
