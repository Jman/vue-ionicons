...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Cloud Upload Outline Icon"
      return {
        iconTitle
      }
    },
