...
<script>
  export default {
    name: "flag-icon",
    data () {
      let iconTitle = this.title ? this.title : "Flag Icon"
      return {
        iconTitle
      }
    },
