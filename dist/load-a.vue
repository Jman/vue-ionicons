...
<script>
  export default {
    name: "load-a-icon",
    data () {
      let iconTitle = this.title ? this.title : "Load A Icon"
      return {
        iconTitle
      }
    },
