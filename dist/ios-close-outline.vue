...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Close Outline Icon"
      return {
        iconTitle
      }
    },
