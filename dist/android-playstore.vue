...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Playstore Icon"
      return {
        iconTitle
      }
    },
