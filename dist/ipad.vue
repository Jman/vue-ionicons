...
<script>
  export default {
    name: "ipad-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ipad Icon"
      return {
        iconTitle
      }
    },
