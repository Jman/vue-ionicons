...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Calculator Icon"
      return {
        iconTitle
      }
    },
