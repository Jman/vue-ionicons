...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Flag Outline Icon"
      return {
        iconTitle
      }
    },
