...
<script>
  export default {
    name: "beer-icon",
    data () {
      let iconTitle = this.title ? this.title : "Beer Icon"
      return {
        iconTitle
      }
    },
