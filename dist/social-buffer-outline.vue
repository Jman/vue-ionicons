...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Buffer Outline Icon"
      return {
        iconTitle
      }
    },
