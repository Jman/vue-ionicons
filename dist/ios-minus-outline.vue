<template>
  <div class="ion ios-minus-outline-icon" name="ios-minus-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-minus-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Minus Outline Icon"
      return {
        iconTitle
      }
    },
