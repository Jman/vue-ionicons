...
<script>
  export default {
    name: "mic-a-icon",
    data () {
      let iconTitle = this.title ? this.title : "Mic A Icon"
      return {
        iconTitle
      }
    },
