...
<script>
  export default {
    name: "key-icon",
    data () {
      let iconTitle = this.title ? this.title : "Key Icon"
      return {
        iconTitle
      }
    },
