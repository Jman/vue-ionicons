...
<script>
  export default {
    name: "paperclip-icon",
    data () {
      let iconTitle = this.title ? this.title : "Paperclip Icon"
      return {
        iconTitle
      }
    },
