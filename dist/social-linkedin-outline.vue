...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Linkedin Outline Icon"
      return {
        iconTitle
      }
    },
