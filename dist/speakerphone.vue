...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Speakerphone Icon"
      return {
        iconTitle
      }
    },
