...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Person Outline Icon"
      return {
        iconTitle
      }
    },
