...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Bus Icon"
      return {
        iconTitle
      }
    },
