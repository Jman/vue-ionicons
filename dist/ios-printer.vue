...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Printer Icon"
      return {
        iconTitle
      }
    },
