<template>
  <div class="ion ios-world-outline-icon" name="ios-world-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-world-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios World Outline Icon"
      return {
        iconTitle
      }
    },
