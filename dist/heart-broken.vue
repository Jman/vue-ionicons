...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Heart Broken Icon"
      return {
        iconTitle
      }
    },
