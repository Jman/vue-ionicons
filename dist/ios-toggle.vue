...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Toggle Icon"
      return {
        iconTitle
      }
    },
