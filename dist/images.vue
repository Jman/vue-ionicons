...
<script>
  export default {
    name: "images-icon",
    data () {
      let iconTitle = this.title ? this.title : "Images Icon"
      return {
        iconTitle
      }
    },
