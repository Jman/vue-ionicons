...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Paintbrush Icon"
      return {
        iconTitle
      }
    },
