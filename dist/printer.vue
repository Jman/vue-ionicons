...
<script>
  export default {
    name: "printer-icon",
    data () {
      let iconTitle = this.title ? this.title : "Printer Icon"
      return {
        iconTitle
      }
    },
