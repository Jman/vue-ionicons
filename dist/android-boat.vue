...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Boat Icon"
      return {
        iconTitle
      }
    },
