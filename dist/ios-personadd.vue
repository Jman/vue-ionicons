...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Personadd Icon"
      return {
        iconTitle
      }
    },
