...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Yahoo Outline Icon"
      return {
        iconTitle
      }
    },
