...
<script>
  export default {
    name: "usb-icon",
    data () {
      let iconTitle = this.title ? this.title : "Usb Icon"
      return {
        iconTitle
      }
    },
