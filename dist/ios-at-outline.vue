...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios At Outline Icon"
      return {
        iconTitle
      }
    },
