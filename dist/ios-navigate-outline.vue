<template>
  <div class="ion ios-navigate-outline-icon" name="ios-navigate-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Navigate Outline Icon"
      return {
        iconTitle
      }
    },
