...
<script>
  export default {
    name: "loop-icon",
    data () {
      let iconTitle = this.title ? this.title : "Loop Icon"
      return {
        iconTitle
      }
    },
