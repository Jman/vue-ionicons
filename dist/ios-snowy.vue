...
<script>
  export default {
    name: "ios-snowy-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Snowy Icon"
      return {
        iconTitle
      }
    },
