<template>
  <div class="ion social-dribbble-outline-icon" name="social-dribbble-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "social-dribbble-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Dribbble Outline Icon"
      return {
        iconTitle
      }
    },
