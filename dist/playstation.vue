...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Playstation Icon"
      return {
        iconTitle
      }
    },
