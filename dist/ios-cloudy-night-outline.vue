...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Cloudy Night Outline Icon"
      return {
        iconTitle
      }
    },
