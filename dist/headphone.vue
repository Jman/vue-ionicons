...
<script>
  export default {
    name: "headphone-icon",
    data () {
      let iconTitle = this.title ? this.title : "Headphone Icon"
      return {
        iconTitle
      }
    },
