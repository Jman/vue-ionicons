...
<script>
  export default {
    name: "wineglass-icon",
    data () {
      let iconTitle = this.title ? this.title : "Wineglass Icon"
      return {
        iconTitle
      }
    },
