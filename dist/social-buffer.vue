...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Buffer Icon"
      return {
        iconTitle
      }
    },
