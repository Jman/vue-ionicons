...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Compose Outline Icon"
      return {
        iconTitle
      }
    },
