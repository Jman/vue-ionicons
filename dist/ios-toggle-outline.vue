...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Toggle Outline Icon"
      return {
        iconTitle
      }
    },
