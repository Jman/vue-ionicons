...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Arrow Up C Icon"
      return {
        iconTitle
      }
    },
