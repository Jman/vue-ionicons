...
<script>
  export default {
    name: "merge-icon",
    data () {
      let iconTitle = this.title ? this.title : "Merge Icon"
      return {
        iconTitle
      }
    },
