<template>
  <div class="ion android-notifications-icon" name="android-notifications-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Notifications Icon"
      return {
        iconTitle
      }
    },
