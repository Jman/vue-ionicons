<template>
  <div class="ion ios-plus-outline-icon" name="ios-plus-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-plus-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Plus Outline Icon"
      return {
        iconTitle
      }
    },
