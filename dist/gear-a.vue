...
<script>
  export default {
    name: "gear-a-icon",
    data () {
      let iconTitle = this.title ? this.title : "Gear A Icon"
      return {
        iconTitle
      }
    },
