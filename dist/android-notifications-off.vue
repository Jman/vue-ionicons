<template>
  <div class="ion android-notifications-off-icon" name="android-notifications-off-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Notifications Off Icon"
      return {
        iconTitle
      }
    },
