...
<script>
  export default {
    name: "email-icon",
    data () {
      let iconTitle = this.title ? this.title : "Email Icon"
      return {
        iconTitle
      }
    },
