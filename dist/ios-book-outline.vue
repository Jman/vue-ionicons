...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Book Outline Icon"
      return {
        iconTitle
      }
    },
