...
<script>
  export default {
    name: "compose-icon",
    data () {
      let iconTitle = this.title ? this.title : "Compose Icon"
      return {
        iconTitle
      }
    },
