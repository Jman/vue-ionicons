<template>
  <div class="ion social-dribbble-icon" name="social-dribbble-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "social-dribbble-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Dribbble Icon"
      return {
        iconTitle
      }
    },
