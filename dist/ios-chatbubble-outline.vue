<template>
  <div class="ion ios-chatbubble-outline-icon" name="ios-chatbubble-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Chatbubble Outline Icon"
      return {
        iconTitle
      }
    },
