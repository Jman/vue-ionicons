...
<script>
  export default {
    name: "outlet-icon",
    data () {
      let iconTitle = this.title ? this.title : "Outlet Icon"
      return {
        iconTitle
      }
    },
