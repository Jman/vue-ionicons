...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Cloud Download Outline Icon"
      return {
        iconTitle
      }
    },
