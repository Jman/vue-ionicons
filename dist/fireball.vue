...
<script>
  export default {
    name: "fireball-icon",
    data () {
      let iconTitle = this.title ? this.title : "Fireball Icon"
      return {
        iconTitle
      }
    },
