...
<script>
  export default {
    name: "steam-icon",
    data () {
      let iconTitle = this.title ? this.title : "Steam Icon"
      return {
        iconTitle
      }
    },
