...
<script>
  export default {
    name: "unlocked-icon",
    data () {
      let iconTitle = this.title ? this.title : "Unlocked Icon"
      return {
        iconTitle
      }
    },
