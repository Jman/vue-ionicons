...
<script>
  export default {
    name: "chatboxes-icon",
    data () {
      let iconTitle = this.title ? this.title : "Chatboxes Icon"
      return {
        iconTitle
      }
    },
