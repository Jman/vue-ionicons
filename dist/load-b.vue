...
<script>
  export default {
    name: "load-b-icon",
    data () {
      let iconTitle = this.title ? this.title : "Load B Icon"
      return {
        iconTitle
      }
    },
