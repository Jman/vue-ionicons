...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Timer Outline Icon"
      return {
        iconTitle
      }
    },
