...
<script>
  export default {
    name: "flash-off-icon",
    data () {
      let iconTitle = this.title ? this.title : "Flash Off Icon"
      return {
        iconTitle
      }
    },
