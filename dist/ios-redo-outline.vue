...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Redo Outline Icon"
      return {
        iconTitle
      }
    },
