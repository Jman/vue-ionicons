<template>
  <div class="ion ios-wineglass-outline-icon" name="ios-wineglass-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-wineglass-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Wineglass Outline Icon"
      return {
        iconTitle
      }
    },
