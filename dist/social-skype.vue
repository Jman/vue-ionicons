...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Skype Icon"
      return {
        iconTitle
      }
    },
