...
<script>
  export default {
    name: "person-icon",
    data () {
      let iconTitle = this.title ? this.title : "Person Icon"
      return {
        iconTitle
      }
    },
