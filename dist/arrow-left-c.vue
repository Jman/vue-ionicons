...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Arrow Left C Icon"
      return {
        iconTitle
      }
    },
