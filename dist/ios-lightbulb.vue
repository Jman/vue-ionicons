<template>
  <div class="ion ios-lightbulb-icon" name="ios-lightbulb-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-lightbulb-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Lightbulb Icon"
      return {
        iconTitle
      }
    },
