...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Share Alt Icon"
      return {
        iconTitle
      }
    },
