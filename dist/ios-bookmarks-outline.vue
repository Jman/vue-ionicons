...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Bookmarks Outline Icon"
      return {
        iconTitle
      }
    },
