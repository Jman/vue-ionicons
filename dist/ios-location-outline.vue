<template>
  <div class="ion ios-location-outline-icon" name="ios-location-outline-icon" :aria-labelledby="iconTitle">
...
<script>
  export default {
    name: "ios-location-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Location Outline Icon"
      return {
        iconTitle
      }
    },
