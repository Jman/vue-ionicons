...
<script>
  export default {
    name: "load-d-icon",
    data () {
      let iconTitle = this.title ? this.title : "Load D Icon"
      return {
        iconTitle
      }
    },
