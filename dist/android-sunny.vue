...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Sunny Icon"
      return {
        iconTitle
      }
    },
