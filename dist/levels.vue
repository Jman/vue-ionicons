...
<script>
  export default {
    name: "levels-icon",
    data () {
      let iconTitle = this.title ? this.title : "Levels Icon"
      return {
        iconTitle
      }
    },
