...
<script>
  export default {
    name: "network-icon",
    data () {
      let iconTitle = this.title ? this.title : "Network Icon"
      return {
        iconTitle
      }
    },
