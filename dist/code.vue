...
<script>
  export default {
    name: "code-icon",
    data () {
      let iconTitle = this.title ? this.title : "Code Icon"
      return {
        iconTitle
      }
    },
